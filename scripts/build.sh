...
apollo_config_db_url=jdbc:oracle:thin:@localhost:1521:orcl
apollo_config_db_username=ApolloConfig
apollo_config_db_password=ApolloConfig
...
apollo_portal_db_url=jdbc:oracle:thin:@localhost:1521:orcl
apollo_portal_db_username=ApolloPortal
apollo_portal_db_password=ApolloPortal
